...
<div class="sub-top-row"><div class="sub-field-grp"><label class="sub-lbl" for="air-rank-inp">等級</label><input type="number" id="air-rank-inp" class="sub-inp" value="1" min="1" max="50"><span class="sub-exp-next" id="air-exp-next"></span><span class="sub-exp-badge" id="air-exp-badge" data-tip-wide="1" data-tip="" title="查看全部等級經驗需求">i</span></div><button id="air-search-btn" class="sub-search-btn" style="margin-left:auto">搜　尋</button><button id="air-clear-btn" class="sub-clear-btn">清除篩選</button><button id="air-parts-mode-toggle" class="sub-view-btn" type="button">切換「擁有部件」選項</button><button id="air-view-toggle" class="sub-view-btn" type="button">切換為精簡模式</button><button id="air-map-btn" class="sub-view-btn" type="button">探索地圖</button></div>
